...
lidar_fov = (1 + 1 / 3) * math.pi
half_fov_behind = (lidar_fov - math.pi) / 2
lidar_end = (1 + half_fov_behind) * math.pi
lidar_start = - half_fov_behind
lidar_angular_resolution = 0.5 / 180 * math.pi
number_of_samples = lidar_fov / lidar_angular_resolution
max_view_distance = 2
...
x_occupied = random_radial_distances * np.cos(phi_lidar_angles)
